...
1. copy the setNoNotification folder in the mod folder of your Elgg installation,

2. enable the plugin in the admin section of your site and configure the notification settings on the plugin settings page of the Set No Notification plugin.
